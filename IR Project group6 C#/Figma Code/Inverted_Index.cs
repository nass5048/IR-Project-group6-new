										...
										new AutoLayout()
											...
											(
												new TextBlock()
													...
													.Text(Term Frequency)
													.Foreground(ThemeResource.GetBrush(Black)),
												new Rectangle()
													.RadiusX(1)
													.RadiusY(1)
													.Fill(ThemeResource.GetBrush(Black))
													.Height(2)
										...
										new AutoLayout()
											...
											(
												new TextBlock()
													.TextAlignment(TextAlignment.Center)
													.Text(Inverted Index)
													.Foreground(ThemeResource.GetBrush(Primary_Brush)),
												new Rectangle()
													.RadiusX(1)
													.RadiusY(1)
													.Fill(ThemeResource.GetBrush(Primary_Brush))
													.Height(2)
													.AutoLayout(counterAlignment AutoLayoutAlignment.Stretch)
											)
									),
